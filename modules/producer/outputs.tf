output "vpc_self_link" {
  description = "The self_link of the producer VPC."
  value       = google_compute_network.vpc.self_link
}

output "vpc_name" {
  description = "The full name of the producer VPC, including the prefix."
  value       = google_compute_network.vpc.name
}

output "subnets_by_name" {
  description = "A map of the created subnets, keyed by their short name (e.g., 'central')."
  value = {
